...
def get_display_instances(image, boxes, masks, class_ids, class_names, scores,
                      ...
                      show_mask=True, show_bbox=True, auto_show=False,
                      colors=None, captions=None, get_mask=True, filepath=None, filename=None):
  ...
  T1 = time.time()
  time_taken_viz_and_json = T1 - T0
  log.info("time_taken_viz_and_json: {}".format(time_taken_viz_and_json))
  ...
  jsonres = {
    ...
    ,"file_attributes":{
      "width": width
      ,"height": height
      ,"time_taken_viz_and_json": time_taken_viz_and_json
    }
  }
