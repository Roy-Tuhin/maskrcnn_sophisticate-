...
def load_graph(weights_path):
  ...
  ## https://www.tensorflow.org/api_docs/python/tf/io/gfile/GFile?version=stable

  ## https://stackoverflow.com/questions/58267272/module-tensorflow-has-no-attribute-graphdef

  # gfile = tf.gfile if 'gfile' in tf else tf.io.gfile
