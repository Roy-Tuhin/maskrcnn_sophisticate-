...
DEFAULT_KITTI_DIR = "/aimldl-dat/data-public/vid2depth/kitti-raw-uncompressed"
DEFAULT_OUTPUT_DIR = "/aimldl-dat/logs/vid2depth"
  ...
  with sv.managed_session() as sess:
    ...
    for i in range(0, len(im_files), FLAGS.batch_size):
      ...
      for b in range(FLAGS.batch_size):
        ...
        inputs[b] = np.array(Image.fromarray(im).resize(FLAGS.img_height, FLAGS.img_width))
      ...
      for b in range(FLAGS.batch_size):
        ...
        imageio.imsave(depth_path, vertical_stack)
